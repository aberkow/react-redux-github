...
/***/ function(module, exports, __webpack_require__) {
	...
	var RepositoryList = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = createStore(reducers.repositoryReducer, window.devToolsExtension ? window.devToolsExtension() : undefined, applyMiddleware(thunk));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repository = __webpack_require__(192);
	...
	var RepositoryList = React.createClass({
	  ...
	  render: function render() {
	    var repositories = this.props.repositories.map(function (repository) {
	      return React.createElement(Repository, { repository: repository, key: repository.name, __self: this
	      });
	    });
	    return React.createElement(
	      'div',
	      { className: 'repository-list', __self: this
	      },
	      repositories,
	      React.createElement('input', { type: 'text', ref: 'repositoryName', __self: this
	      }),
	      React.createElement(
	        'button',
	        { type: 'button', onClick: this.addRepository, __self: this
	        },
	        'Add repository'
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StarRater = __webpack_require__(193);
	...
	var Repository = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'repository', __self: this
	      },
	      ...
	      React.createElement(StarRater, { rating: this.props.repository.rating,
	        onChange: this.changeRating, __self: this
	      })
	    );
	  }
	});
	...
	var StarRater = React.createClass({
	  ...
	  render: function render() {
	    ...
	    for (var i = 0; i < 5; i++) {
	      ...
	      var star = React.createElement('i', { className: className, key: i, onClick: this.props.onChange.bind(null, i + 1), __self: this
	      });
	      stars.push(star);
	    }
	    return React.createElement(
	      'span',
	      { className: 'star-rater', __self: this
	      },
	      stars
	    );
	  }
